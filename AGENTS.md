...
1. Make polish markdown cells
2. Make english code cells
3. Always check for ruff and pylance warnings/errors -> if there are any your code is not correct
4. Write your code in Jupyter notebooks -> labXX/labXX.ipynb
